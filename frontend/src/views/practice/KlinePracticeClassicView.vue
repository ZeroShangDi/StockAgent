      ...
      <div>
        ...
        <div class="hero-title-row">
          ...
          <div class="mode-switch">
            <el-button type="primary" plain size="small" @click="goImmersive">沉浸模式</el-button>
            <el-button size="small" disabled>经典模式</el-button>
          </div>
        </div>
        <p class="description">
          这是第一版的经典工作台，保留完整信息面板，方便对照沉浸模式使用。
        </p>
      </div>
