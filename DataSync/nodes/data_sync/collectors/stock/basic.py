...
class StockBasicCollector(BaseCollector):
    ...
    resource_class = "core"
    target_collections = ("stock_basic",)
    dependencies = ("daily_basic:latest_optional",)
    source_chain_keys = ("get_stock_basic", "get_daily_basic.full_market")
    quality_checks = ("required_fields:ts_code,name,list_status", "dedupe_key:ts_code")
