...
from core.managers.stock_relation_manager import stock_relation_manager
...
class StockRelationsCollector(BaseCollector):
    ...
    dataset_name = "stock_relations"
    resource_class = "core"
    target_collections = ("stock_relations",)
    dependencies = (
        "stock_basic",
        "moneyflow_industry",
        "moneyflow_concept",
    ...
    quality_checks = (
        "required_fields:ts_code,relation_type,relation_name",
        "dedupe_key:ts_code,relation_type,relation_name",
    )
